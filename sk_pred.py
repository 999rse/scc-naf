...
class SKPredModel:
    ...
    def model_keys(self) -> List[str]:
        return ((self.test_df).columns).to_list
    ...
    def prepare_df(self, test_df: pd.DataFrame) -> pd.DataFrame:
        ...
        :param 
            ...
            test_df - датафрейм, с которого надо получить данные
        ...
        task_type = task_type.fillna({'task_cancel': 0, 'task_success': 0, 'task_fail': 0, 'task_timeout': 0})
       ...
       'percentile_90_elapsed']]
        ...
        self.test_df = self.tdf2predict

        scaler = StandardScaler(copy=False)
        self.tdf2predict = scaler.fit_transform(self.tdf2predict)
